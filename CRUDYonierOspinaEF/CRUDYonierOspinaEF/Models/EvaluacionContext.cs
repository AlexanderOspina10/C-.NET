...
//        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-AE79JJR\\SQLEXPRESS;Initial Catalog=EVALUACION;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Categoria>(entity =>
        {
            entity.HasKey(e => e.CodigoCategoria).HasName("PK__Categori__738F04ADCB1724D7");
        ...
        {
            entity.HasKey(e => e.Nit).HasName("PK__Editoria__C7D1D6DB2A08046E");
        ...
        {
            entity.HasKey(e => e.Isbn).HasName("PK__Libros__9271CED1F3DB45F0");
